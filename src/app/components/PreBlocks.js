...
월드보스 인페르날 소환 쿨타임이 1800초 -> 1200초로 조정됩니다.
이벤트 보스 저거넛의 드랍 보상이 개편되며, 소환 쿨타임이 7200초 -> 5400초로 조정됩니다.

신규 컨텐츠 '시련의 탑'이 추가됩니다.

매일 최대 1회 진행할 수 있으며, 기록한 점수량에 따라 보상이 지급됩니다.
최소 입장 레벨 : 800

신규 파츠 '마스터리 북'이 추가됩니다.
마스터리 북은 시련의 탑 상점에서 강화 또는 구매가 가능합니다.

힘의 책 - 힘 스탯을 증가시킵니다.
민첩의 책 - 민첩 스탯을 증가시킵니다.
지능의 책 - 지능 스탯을 증가시킵니다.

최대 1000단계 까지 강화가 가능하며, 매 강화시 재화가 소모됩니다.
재화 소모량 : (강화단계^2) + (강화단계*700) 골드, 강화단계 구간별 특수재화 소모
