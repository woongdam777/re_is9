...
등급 S~C, n = 등급 비례 효과, 등급이 올라갈 수록 효과가 증폭

소울 애로우 - 마지막 공격'단일'대상
0.8초마다 공격력 * 5.1 / 7.2 / 9.5 / 15 추가 피해

베리어 - 10초마다 n초간 최대체력 n% 쉴드 부여
3초지속 10% / 5초지속 15% / 7초지속 20% / 10초지속 25%

찬스 어택 - 펫공격 한번 더
8% / 14.4.% / 28.8% / 57.6% 확률

위협 - 10초마다 방관증가
6초지속 4% / 10초지속 6% / 10초지속 10%

저주 - '단일'대상 받는 피해량 증가, 중첩불가
5초마다 3초지속 10% / 5초지속 10% / 5초지속 15%

축복 - 10초마다 공격력 증폭
6초지속 15% / 10초지속 25% / 10초지속 40%

축복 - 10초마다 치명타 증가
6초지속 12% / 10초지속 20% / 10초지속 30%

행운의 주사위 - 10초마다 주스탯을 n~n% 증가
6초지속 3~8% / 10초지속 5~10% / 10초지속 10~15%
`;
  return (
    <pre>{pres}</pre>
  );
